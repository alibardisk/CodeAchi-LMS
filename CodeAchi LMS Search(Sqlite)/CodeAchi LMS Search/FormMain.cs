...
namespace CodeAchi_LMS_Search
{
    public partial class FormMain : Form
    {
        ...
        {
            //lblCompany1.Location = new Point(lblCompany1.Location.X + 1, lblCompany1.Location.Y);
            //lblCompany.Location = new Point(lblCompany.Location.X + 1, lblCompany.Location.Y);
            //pnlMove.Location = new Point(pnlMove.Location.X + 1, pnlMove.Location.Y);

            //if (this.WindowState == FormWindowState.Maximized)
            //{
            //    if (lblCompany1.Location.X == 795)
            //    {
            //        lblCompany.Location = new Point(-365, lblCompany1.Location.Y);
            //    }
            //    if (lblCompany.Location.X == 795)
            //    {
            //        lblCompany1.Location = new Point(-365, lblCompany1.Location.Y);
            //    }
            //    if (lblCompany1.Location.X == 1173)
            //    {
            //        lblCompany1.Location = new Point(1173, lblCompany1.Location.Y);
            //    }
            //    if (lblCompany.Location.X == 1173)
            //    {
            //        lblCompany.Location = new Point(1173, lblCompany1.Location.Y);
            //    }
            //    if (pnlMove.Location.X == 1076)
            //    {
            //        pnlMove.Location = new Point(260, pnlMove.Location.Y);
            //    }
            //}
            //else
            //{
            //    if (lblCompany1.Location.X == 584)
            //    {
            //        lblCompany.Location = new Point(-365, lblCompany1.Location.Y);
            //    }
            //    if (lblCompany.Location.X == 584)
            //    {
            //        lblCompany1.Location = new Point(-365, lblCompany1.Location.Y);
            //    }
            //    if (lblCompany1.Location.X == 962)
            //    {
            //        lblCompany1.Location = new Point(962, lblCompany1.Location.Y);
            //    }
            //    if (lblCompany.Location.X == 962)
            //    {
            //        lblCompany.Location = new Point(962, lblCompany1.Location.Y);
            //    }
            //    if (pnlMove.Location.X == 916)
            //    {
            //        pnlMove.Location = new Point(260, pnlMove.Location.Y);
            //    }
            //}
