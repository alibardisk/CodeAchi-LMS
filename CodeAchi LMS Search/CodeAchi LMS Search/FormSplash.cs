        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (Properties.Settings.Default.sqliteDatabase)
            {
                ...
                string queryString = "select instName,instLogo,instAddress,instShortName,currSymbol," +
                       "databasePath,backupPath,backupHour,printerName,opacAvailable,notificationData,settingsData from generalSettings";
            ...
            else
            {
                ...
                string queryString = "select productBlocked,productExpired,reserveSystemLimit,machineId from general_settings where licenseType!='Demo'";
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (macIds == "")
                                {
                                    queryString = "update general_settings set machineId ='" + machineId + "'";
                                    mysqlCmd = new MySqlCommand(queryString, mysqlConn);
                                    mysqlCmd.CommandTimeout = 99999;
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            queryString = "update general_settings set machineId ='" + macIds + "$" + machineId + "'";
                                            mysqlCmd = new MySqlCommand(queryString, mysqlConn);
                                            mysqlCmd.CommandTimeout = 99999;
                                            mysqlCmd.ExecuteNonQuery();
                                        }
                    ...
                    if (Properties.Settings.Default.machineId == machineId)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (mysqlConn.State.ToString() == "Closed")
                                {
                                    timer2.Start();
                                }
                                else
