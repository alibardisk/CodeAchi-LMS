...
namespace CodeAchi_Library_Management_System
{
    public partial class FormAbout : Form
    {
        ...
        private void FormAbout_Load(object sender, EventArgs e)
        {
            ...
            // Convert ISO date string to DateTimeOffset
            DateTimeOffset dateTimeOffset = DateTimeOffset.Parse(globalVarLms.expiryDate.ToString());
            // Convert DateTimeOffset to local date and time
            DateTime renewDate = dateTimeOffset.LocalDateTime.AddDays(1);
                ...
                if (dataReader.HasRows)
                {
                    while (dataReader.Read())
                    {
                        ...
                        if (settingsData != "")
                        {
                            ...
                            copyInfo = "Machine Id : " + lblMac.Text + 
