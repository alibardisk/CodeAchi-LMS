            ...
            if (IsConnectedToInternet() == true)
            {
                try
                {
                    ...
                    if (requestResult == null)
                    {
                        ...
                        string queryToInsert = "INSERT INTO installationDetails (mac,productName,isBlocked,licenseKey,installDate,ip,productUninstalled,org_name,email,country,address) VALUES('" + globalVarLms.machineId + "', '" + Application.ProductName + "','" + false + "','" + Properties.Settings.Default.serialKey + "','" + installedDate + "','" + GetGlobalIP() + "','" + false + "','" + instName + "','" + instMail + "','" + countryName + "','" + instAddress + "')";
                        //ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls12;
