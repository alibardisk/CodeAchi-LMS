    ...
    public partial class FormWizard : Form
    {
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            else if (lblStepCount.Text == 5.ToString())
            {
                ...
                Properties.Settings.Default.currentDate = DateTime.Now.Day.ToString("00") + "/" + DateTime.Now.Month.ToString("00") + "/" + DateTime.Now.Year.ToString("0000");
                Properties.Settings.Default.expiryDate = DateTime.Now.Day.ToString("00") + "/" + DateTime.Now.Month.ToString("00") + "/" + DateTime.Now.Year.ToString("0000");
